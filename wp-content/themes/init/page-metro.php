                        ...
                        <div class="container">
                            <div class="wrapper article-md">
                                <div class="inline full">
                                    <div class="line">
                                        <div class="h2">' . $title . ' на станции метро '.METRO_NAME.'</div>
                                        <div class="grow"></div>
    ...
    <?php
        $blocks = [
            [
                [
                    'type' => 'text',
                    'title' => 'Почему Flowlove - лучший выбор для заказа цветов в районе метро [metro_name]?',
                    'text' => '
                        <ul>
                            ...
                            <li><b>Доставка курьером.</b> Мы осуществляем доставку цветов прямо к двери вашего получателя в районе метро [metro_name]. Курьер быстро и надежно доставит букет цветов в удобное для вас время, и вы можете быть уверены, что подарок прибудет в сохранности.</li>
                        </ul>
                        <p>Мы приглашаем вас воспользоваться нашей услугой и порадовать своих близких в районе метро [metro_name] красивым и стильным букетом цветов.</p>
                    ',
                ],
                [
                    'type' => 'image',
